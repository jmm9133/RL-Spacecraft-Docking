...
TIMESTEP = 0.01
MAX_STEPS_PER_EPISODE = 3600 # Reduced slightly for faster iteration, adjust as needed
...
POTENTIAL_WEIGHT_DISTANCE = 120.0 # *** TUNE THIS (e.g., 10, 50, 100) ***
...
POTENTIAL_WEIGHT_VELOCITY = 1.0 # *** TUNE THIS (e.g., 0.5, 1.0, 2.0) ***
...
POTENTIAL_WEIGHT_ORIENT = 5.0 # *** TUNE THIS (e.g., 0.0, 1.0, 5.0, 10.0) ***
...
DOCKING_ORIENT_THRESHOLD = 0.2 # Max radians error (~11.5 degrees) - tune this!

# --- OOB Threshold (Example) ---
OUT_OF_BOUNDS_DISTANCE = 10.0 # Distance beyond which OOB penalty applies
...
INITIAL_POS_RANGE_TARGET = [[-2, -2, -0.5], [2, 2, 0.5]] # Random offset RELATIVE to servicer origin
