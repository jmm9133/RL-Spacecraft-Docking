...
REWARD_WEIGHT_DISTANCE = -0.05       # Keep distance penalty (or slightly reduce, e.g., -0.02)

# --- FIX: Adjust Shaping Rewards ---
REWARD_WEIGHT_VELOCITY_MAG = -0.001   # Reduced penalty (Optional)
REWARD_WEIGHT_ACTION_COST = -0.0001   # Significantly reduce action cost penalty
REWARD_WEIGHT_DISTANCE_DELTA = 5.0   # *** Significantly increase reward for getting closer ***
# --- End FIX ---
# Docking Thresholds
