...
ACTION_FORCE_SCALING = 1.0 # Back to original, maybe even higher?
ACTION_TORQUE_SCALING = 0.9 # Back to original
# --- End FIX ---
...
REWARD_WEIGHT_DISTANCE = -0.01      # Keep distance penalty (or slightly reduce, e.g., -0.02)

# --- FIX: Adjust Shaping Rewards ---
REWARD_WEIGHT_VELOCITY_MAG = -0.01   # Reduced penalty (Optional)
REWARD_WEIGHT_ACTION_COST = -0.01   # Significantly reduce action cost penalty
