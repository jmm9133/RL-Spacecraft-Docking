...
POTENTIAL_WEIGHT_DISTANCE = 0.5  # Tune (e.g., 0.1 to 2.0) - How much potential increases per meter closer
POTENTIAL_WEIGHT_VELOCITY = 0.1  # Tune (e.g., 0.05 to 1.0) - How much potential decreases with square of velocity
POTENTIAL_WEIGHT_ORIENT = 0.1  # Tune (e.g., 0.1 to 1.0) - How much potential decreases with orientation error (radians) - SET TO 0 IF NOT USING ORIENTATION
...
# GAMMA = 0.99 # Define if using potential-based shaping requiring gamma