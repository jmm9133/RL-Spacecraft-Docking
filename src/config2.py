...
INITIAL_POS_RANGE_TARGET = [3.0, 1.0]     # Range for relative target position - more reasonable
...
POTENTIAL_WEIGHT_DISTANCE = 8.0           # Distance component weight (greatly reduced)
POTENTIAL_WEIGHT_VELOCITY = 1.0           # Velocity component weight (reduced)
POTENTIAL_WEIGHT_ORIENT = 0.5             # Orientation component weight (reduced)
